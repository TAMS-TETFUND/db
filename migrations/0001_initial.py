# Generated by Django 4.0.3 on 2022-07-31 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2022, 7, 31, 16, 33, 51, 661440, tzinfo=utc))),
        ...
        migrations.AddField(
            model_name='attendancesession',
            name='node_device',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.nodedevice'),
        ),
        migrations.AddField(
            model_name='attendancesession',
            name='session',
