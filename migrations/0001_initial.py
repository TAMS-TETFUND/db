...
=======
# Generated by Django 4.0.3 on 2022-07-28 08:57
>>>>>>> Stashed changes
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('record_type', models.IntegerField(choices=[(1, 'Sign In'), (2, 'Sign Out')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('event_type', models.IntegerField(choices=[(1, 'Lecture'), (2, 'Lab'), (3, 'Quiz'), (4, 'Examination')])),
<<<<<<< Updated upstream
                ('start_time', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 8, 41, 39, 432046, tzinfo=utc))),
=======
                ('start_time', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 8, 57, 28, 642149, tzinfo=utc))),
>>>>>>> Stashed changes
                ('duration', models.DurationField()),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('status', models.IntegerField(choices=[(1, 'Active'), (2, 'Ended')], default=1)),
        ...
        migrations.CreateModel(
            name='Staff',
            fields=[
                ('appuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to=settings.AUTH_USER_MODEL)),
                ('staff_number', models.CharField(max_length=25, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('reg_number', models.TextField(primary_key=True, serialize=False, unique=True)),
